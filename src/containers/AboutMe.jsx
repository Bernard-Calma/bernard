    ...
    return (
        <section className="sectionAboutMe" id="idAboutMe">
                <div className="aboutMe">
                    ...
                    <a href="https://docs.google.com/document/d/1SMeSCKhxjsBJG1urZ6vdavFdLWlSewfA/edit?usp=sharing&ouid=103996762752011902027&rtpof=true&sd=true" id="fileResume" target={"_blank"} rel = {"external"}>Resume</a>
                </div>
