    ...
    return(
        <div className={`divProject ${props.index === props.show ? `active `: `hidden`}`}>
            ...
            <div className="containerImage">
                <a href={props.project.websiteLink} target={'_blank'} rel={'noreferrer'} className="projectLink"><img className="projectImage" src={props.project.screenshot} alt={props.project.name}/></a>
            </div>
